        ...
        return dataStream
                ...
                .process(new BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject, TableProcessDwd>>() {
                    ...
                    public void open(Configuration parameters) throws Exception {
                        ...
                        java.sql.Connection mysqlConn = JdbcUtils.getMySQLConnection( Constant.MYSQL_URL, Constant.MYSQL_USER_NAME, Constant.MYSQL_PASSWORD);
                        List<TableProcessDwd> tableProcessDwdList = JdbcUtils.queryList(mysqlConn,
                        ...
                        JdbcUtils.closeMySQLConnection(mysqlConn);
                    }
